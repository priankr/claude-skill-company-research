...
**Note:** This research reports generated by this Claude Skill are meant to be a **starting point**. You have to rensure you review and refine the output for your specific use case. Also since these reports are AI generated, always check for inconsistencies, hallucinations, and errors in the reports.  
...
| [skill-usage-guide.md] | Skill Usage Instructions & Guidance |
