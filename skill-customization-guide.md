...
**Note:** See [skill-usage-guide.md](https://github.com/priankr/claude-skill-company-research/blob/main/skill-usage-guide.md) for instructions how to use the skill.
